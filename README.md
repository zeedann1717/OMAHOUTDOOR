...
-Buka folder C:\xampp\htdocs\ di laptop kalian.
-Klik kanan di area kosong, pilih Open Git Bash here.
-Ketik perintah ini buat narik semua file dari GitHub:
*git clone https://github.com/zeedann1717/OMAHOUTDOOR.git*
-Nanti bakal otomatis muncul folder OMAHOUTDOOR di dalem htdocs kalian.
...
2.Buka browser, ketik alamat: localhost/phpmyadmin
