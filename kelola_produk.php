...
$notif = '';
$notif_class = '';
if ($pesan === 'tambah_sukses bro') {
    $notif = '✅ Produk berhasil ditambahkan!';
    $notif_class = 'notif-sukses';
} elseif ($pesan === 'edit_sukses bro') {
    $notif = '✅ Produk berhasil diupdate!';
    $notif_class = 'notif-sukses';
} elseif ($pesan === 'hapus_sukses bro') {
    $notif = '🗑️ Produk berhasil dihapus!';
    $notif_class = 'notif-hapus';
} elseif ($pesan === 'waduh gagal bro') {
    $notif = '❌ Terjadi kesalahan, coba lagi.';
...
<head>
    ...
    <style>
        ...
        .preview-gambar img {
            ...
            object-fit: cover;
            border-radius: 12px;
            border: 2px solid #EDF0EC;
        }

        .preview-gambar small {
            display: block;
            font-size: 11px;
            color: #94a3b8;
            margin-top: 4px;
                ...
                <div class="form-grid">
                    ...
                    <div class="fg">
                        ...
                        <input type="number" name="harga_per_hari" required min="0"
                            value="<?= $edit_data['harga_per_hari'] ?? '' ?>" placeholder="Contoh: 35000">
                    </div>

                    <div class="fg">
                        <label>Jumlah Stok (Unit)</label>
                        <input type="number" name="jumlah_stok" required min="0"
                            value="<?= $edit_data['jumlah_stok'] ?? 1 ?>" placeholder="Contoh: 3">
                    </div>
                    ...
                    <div class="fg full">
                        ...
                        <?php if ($edit_data && !empty($edit_data['gambar'])): ?>
                            <div class="preview-gambar">
                                <img src="assets/images/<?= htmlspecialchars($edit_data['gambar']) ?>" alt="Foto saat ini"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <?php if (!empty($p['gambar'])): ?>
                                            <img src="assets/images/<?= htmlspecialchars($p['gambar']) ?>" class="img-thumb"
                                    ...
                                    <td style="text-align:center;">
                                        ...
                                        <a href="proses_produk.php?action=hapus&id=<?= $p['id'] ?>" class="btn-del-tbl"
                            ...
                            <tr>
                                <td colspan="7" style="text-align:center;padding:50px;color:var(--text-light);">
                                    <i class="fa-solid fa-box-open"
                                        style="font-size:40px;display:block;margin-bottom:12px;opacity:.4;"></i>
