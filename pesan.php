...
<body>
    ...
    <div class="order-container">
        <div class="order-card">
            ...
            <div class="produk-preview">
                <div class="produk-img-wrap">
                    <img src="assets/images/<?= htmlspecialchars($produk['gambar']) ?>"
                        alt="<?= htmlspecialchars($produk['nama_produk']) ?>" onerror="this.style.display='none'">
                </div>
                <div class="produk-detail">
                    <h2><?= htmlspecialchars($produk['nama_produk']) ?></h2>
                    <p class="harga-produk">Rp <?= number_format($produk['harga_per_hari'], 0, ',', '.') ?> <span>/
                            hari</span></p>
            ...
            <form action="proses_pesan.php" method="POST" id="form-pesan">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_mulai" id="tgl-mulai" min="<?= date('Y-m-d') ?>" required>
                    </div>
                    <div class="form-group">
            ...
            <p class="order-note">⚠️ Setelah memesan, tunjukkan QR Code ke kasir untuk konfirmasi pengambilan barang.
            </p>
        </div>
    </div>
