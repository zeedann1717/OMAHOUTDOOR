...
$notif = '';
$notif_class = '';
if ($pesan === 'profil_sukses') {
    $notif = '✅ Profil berhasil diperbarui bro!';
    $notif_class = 'notif-sukses';
} elseif ($pesan === 'nama_kosong') {
    $notif = '⚠️ Nama tidak boleh kosong bro!';
    $notif_class = 'notif-gagal';
} elseif ($pesan === 'pass_sukses') {
    $notif = '✅ Password berhasil diganti bro!';
    $notif_class = 'notif-sukses';
} elseif ($pesan === 'pass_lama_salah') {
    $notif = '❌ Password lama salah bro!';
    $notif_class = 'notif-gagal';
} elseif ($pesan === 'pass_terlalu_pendek') {
    $notif = '❌ Password baru minimal 6 karakter bro!';
    $notif_class = 'notif-gagal';
} elseif ($pesan === 'pass_tidak_cocok') {
    $notif = '❌ Konfirmasi password tidak cocok bro!';
    $notif_class = 'notif-gagal';
}
...
<body>
        ...
        <div class="container nav-wrapper">
            ...
            <ul class="nav-links">
                ...
                <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                    ...
                    <li><a href="dashboard_admin.php" class="btn-login"
                            style="background-color: #e7c56a; color: #1b4332; font-weight: bold; border-radius: 8px; padding: 6px 12px;">🛠️
    ...
    <div class="profil-container">
        ...
        <div class="profil-grid"
            style="grid-template-columns: <?= $user['role'] === 'admin' ? '1fr 1fr' : '1fr 1fr' ?>;">
            ...
            <div class="profil-card">
                ...
                <form action="proses_profil.php" method="POST">
                    ...
                    <div class="profil-form-group">
                        ...
                        <input type="tel" name="no_wa" value="<?= htmlspecialchars($user['no_wa'] ?? '') ?>"
            ...
            <?php if ($user['role'] !== 'admin'): ?>
                <div class="profil-card" style="grid-column: span 2;">
                    ...
                    while ($r = mysqli_fetch_assoc($res_order))
                        $o[$r['status']] = $r['total'];
                    ...
                    <a href="riwayat_order.php" class="profil-btn-riwayat" style="margin-top: 15px;">📜 Lihat Riwayat
                        Order</a>
                </div>
            <?php endif; ?>
